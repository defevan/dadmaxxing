...
If you're interested in the code, I think the most notable bit is the "observe" decorator I crafted. I find it makes interacting with [rxjs](https://rxjs.dev/) observables from a Lit web component a breeze. Check it out:
* [Implementation](https://github.com/defevan/dadmaxxing/blob/master/src/lib/observe-decorator.ts)
* [Usage](https://github.com/defevan/dadmaxxing/blob/master/src/components/header.ts#L33)
